...
class YamlConfigLoadTest {
    ...
    static Stream<String> allYamlFiles() {
        return Stream.of(
                ...
                "/zones/hub_hub.yml",
                "/zones/hub_bank.yml",
                "/zones/hub_bazzar_alley.yml",
                "/zones/hub_auction_house.yml",
                "/zones/hub_town_hall.yml",
                "/zones/hub_librarian.yml",
                "/zones/hub_blacksmith.yml",
                "/zones/hub_archery.yml",
                "/zones/hub_beth.yml",
                "/zones/hub_maxwell.yml",
                "/zones/hub_alchemist.yml",
                "/stats/core.yml",
